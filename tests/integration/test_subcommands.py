...
class TestBasicDispatch:
    ...
    def test_unknown_subcommand_exists(self, monkeypatch):
        cli = CLI()
    ...
    def test_subcommand_with_no_arguments(self):
        cli = CLI()
        calls = []
    ...
    def test_cli_run_with_default_argv(self, monkeypatch):
        cli = CLI()
        calls = []
...
class TestHelpOutput:
    ...
    def test_help_list_subcommands(self, capsys):
    ...
    def test_description_override_help(self, capsys):
        cli = CLI(description="Test CLI")
    ...
    def test_per_subcommand_help(self, capsys):
        cli = CLI(description="Test CLI")
    ...
    def test_top_level_help_shows_groups(self, capsys):
...
class TestGroups:
    ...
    def test_group_dispatch_with_flags(self):
        cli = CLI()
        calls = []
    ...
    def test_group_help_shows_nested_commands(self, capsys):
        cli = CLI(description="Root CLI")
    ...
    def test_group_subcmd_with_no_params(self):
        cli = CLI()
        calls = []
    ...
    def test_group_in_group_help(self, capsys):
...
class TestNested:
    ...
    def test_deeply_nested_subcommands(self, monkeypatch):
        cli = CLI()
        calls = []
    ...
    def test_unknown_nested_command(self, monkeypatch):
        cli = CLI()
        db = cli.group("db")
